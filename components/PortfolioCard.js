...
export const PortfolioCard = ({ project, index, selectedCard }) => {
  return (
    <div className="group relative h-full w-full rounded-xl bg-offWhite text-primary ring-4 ring-primary drop-shadow-lg transition duration-200 ease-in-out hover:scale-[102%] hover:transform">
