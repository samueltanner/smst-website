...
export const InteractiveSubHeader = ({}) => {
  ...
  return (
    <motion.div className="relative h-full w-full overflow-y-hidden">
      <CutoutShape />
      <div
        className="relative flex h-full w-[65%] items-end justify-end xl:w-[80%]"
        ref={constraintsRef}
      >
        <div className="justify-top absolute left-0 z-50 flex h-full max-w-full flex-col gap-2  pt-4 pl-4">
